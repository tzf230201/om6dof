# AGX execution checklist — ICRA confirmatory reachability v3
...
Transfer `source_snapshot.tar.gz`, `CONFIRMATORY_PROTOCOL_V3.md`, and this checklist
to `/home/kublab/ros2_ws/confirmatory_candidate_20260825_v3/`. Expected hashes:

```text
source_snapshot.tar.gz
  700da1d28b6597c51611d381c7199eaf866095bb905cae7a240c9969b43b459b
CONFIRMATORY_PROTOCOL_V3.md
  6e577ae75c65ed2399d36332f3ca158faebba5cb7295ea51666a4fc1097cea09
SOURCE_MANIFEST.json (inside the archive; this is source_tree_sha256)
  629f1955ed876bc74ecada312fbb86f168687732d5ea958067a18e37b168d14f
```

On AGX:

```bash
cd /home/kublab/ros2_ws/confirmatory_candidate_20260825_v3
sha256sum source_snapshot.tar.gz CONFIRMATORY_PROTOCOL_V3.md
mkdir -p extracted
...
tar -czf om6dof_dd_gng_before_confirmatory_v3_20260825.tar.gz \
  -C /home/kublab/ros2_ws/src/om6dof om6dof_dd_gng
rsync -a \
  /home/kublab/ros2_ws/confirmatory_candidate_20260825_v3/extracted/package_snapshot/om6dof_dd_gng/ \
...
colcon build --packages-up-to om6dof_dd_gng --symlink-install \
  ...
  --event-handlers console_direct+ 2>&1 | tee confirmatory_build_v3_20260825.log
source install/setup.bash
colcon test --packages-select om6dof_dd_gng \
  --event-handlers console_direct+ 2>&1 | tee confirmatory_test_v3_20260825.log
colcon test-result --verbose 2>&1 | tee confirmatory_test_result_v3_20260825.log
```
...
sha256sum \
  ...
  confirmatory_build_v3_20260825.log \
  confirmatory_test_v3_20260825.log \
  confirmatory_test_result_v3_20260825.log
```
...
python3 src/om6dof/om6dof_dd_gng/scripts/generate_reachability_scene_catalog.py \
  --output /home/kublab/ros2_ws/reachability_scene_catalog_icra_v3.json \
  ...
  2>&1 | tee /home/kublab/ros2_ws/reachability_scene_catalog_icra_v3_generation.log
```
...
python3 src/om6dof/om6dof_dd_gng/scripts/reachability_multiscene_benchmark.py \
  --catalog /home/kublab/ros2_ws/reachability_scene_catalog_icra_v3.json \
  --protocol-id icra_confirmatory_v3 \
  ...
  --rmw-implementation rmw_fastrtps_cpp \
  --source-tree-sha256 629f1955ed876bc74ecada312fbb86f168687732d5ea958067a18e37b168d14f \
  --expected-catalog-sha256 <CATALOG_SHA256> \
  --catalog-generation-log /home/kublab/ros2_ws/reachability_scene_catalog_icra_v3_generation.log \
  --source-snapshot /home/kublab/ros2_ws/confirmatory_candidate_20260825_v3/source_snapshot.tar.gz \
  --protocol-document /home/kublab/ros2_ws/confirmatory_candidate_20260825_v3/CONFIRMATORY_PROTOCOL_V3.md \
  --analyzer-script /home/kublab/ros2_ws/src/om6dof/om6dof_dd_gng/scripts/analyze_reachability_multiscene.py \
  --output-dir /home/kublab/ros2_ws/reachability_icra_confirmatory_v3 \
  --dry-run
```
...
```bash
python3 \
  /home/kublab/ros2_ws/reachability_icra_confirmatory_v3/frozen_inputs/analyze_reachability_multiscene.py \
  --input-dir /home/kublab/ros2_ws/reachability_icra_confirmatory_v3 \
  --output-dir /home/kublab/ros2_ws/reachability_icra_confirmatory_v3/analysis \
