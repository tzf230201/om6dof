# OM6DOF Reachability Benchmark — Confirmatory Protocol v4
...
Protocol v4 was frozen after v3 completed all 21,600 queries and its runner
audit passed, but the separately frozen analyzer still contained the superseded
v2 zero-blocked-edge assertion. V4 applies the same clear-scene contract to the
analyzer (`blocked_nodes=0`, `blocked_edges=exact_replans`) and adds a matching
analyzer regression test. V3 outcomes are excluded. No algorithmic or statistical
setting changed.
