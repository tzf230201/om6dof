# AGX execution checklist — ICRA confirmatory reachability v1
...
Transfer `source_snapshot.tar.gz`, `CONFIRMATORY_PROTOCOL_V1.md`, and this checklist
to `/home/kublab/ros2_ws/confirmatory_candidate_20260824/`. Expected hashes:

```text
source_snapshot.tar.gz
  629d41b12c4357d587e9c632add5b3e68d25e1ff532529e948886039f91a4400
CONFIRMATORY_PROTOCOL_V1.md
  e5f1d18439847fd3518571b77a1573df78fba3f112245c4652a817706d0f387d
SOURCE_MANIFEST.json (inside the archive; this is source_tree_sha256)
  24b645cad37ef9ded7487fa66cbaffbc699bf226c0eef90f1580744812a10b7a
```

On AGX:

```bash
cd /home/kublab/ros2_ws/confirmatory_candidate_20260824
sha256sum source_snapshot.tar.gz CONFIRMATORY_PROTOCOL_V1.md
mkdir -p extracted
...
tar -czf om6dof_dd_gng_before_confirmatory_20260824.tar.gz \
  -C /home/kublab/ros2_ws/src/om6dof om6dof_dd_gng
rsync -a \
  /home/kublab/ros2_ws/confirmatory_candidate_20260824/extracted/package_snapshot/om6dof_dd_gng/ \
...
colcon build --packages-up-to om6dof_dd_gng --symlink-install \
  ...
  --event-handlers console_direct+ 2>&1 | tee confirmatory_build_20260824.log
source install/setup.bash
colcon test --packages-select om6dof_dd_gng \
  --event-handlers console_direct+ 2>&1 | tee confirmatory_test_20260824.log
colcon test-result --verbose 2>&1 | tee confirmatory_test_result_20260824.log
```
...
sha256sum \
  ...
  confirmatory_build_20260824.log \
  confirmatory_test_20260824.log \
  confirmatory_test_result_20260824.log
```
...
python3 src/om6dof/om6dof_dd_gng/scripts/generate_reachability_scene_catalog.py \
  --output /home/kublab/ros2_ws/reachability_scene_catalog_icra_v1.json \
  ...
  --urdf-sha256 485617d99a2483abd6327b03bb6d3a0a52f71be08adba6234343e1e4a1cd328a \
  ...
  2>&1 | tee /home/kublab/ros2_ws/reachability_scene_catalog_icra_v1_generation.log
```
...
python3 src/om6dof/om6dof_dd_gng/scripts/reachability_multiscene_benchmark.py \
  --catalog /home/kublab/ros2_ws/reachability_scene_catalog_icra_v1.json \
  --protocol-id icra_confirmatory_v1 \
  ...
  --rmw-implementation rmw_fastrtps_cpp \
  --source-tree-sha256 24b645cad37ef9ded7487fa66cbaffbc699bf226c0eef90f1580744812a10b7a \
  --expected-catalog-sha256 <CATALOG_SHA256> \
  --catalog-generation-log /home/kublab/ros2_ws/reachability_scene_catalog_icra_v1_generation.log \
  --source-snapshot /home/kublab/ros2_ws/confirmatory_candidate_20260824/source_snapshot.tar.gz \
  --protocol-document /home/kublab/ros2_ws/confirmatory_candidate_20260824/CONFIRMATORY_PROTOCOL_V1.md \
  --analyzer-script /home/kublab/ros2_ws/src/om6dof/om6dof_dd_gng/scripts/analyze_reachability_multiscene.py \
  --output-dir /home/kublab/ros2_ws/reachability_icra_confirmatory_v1 \
  --dry-run
```
...
```bash
python3 \
  /home/kublab/ros2_ws/reachability_icra_confirmatory_v1/frozen_inputs/analyze_reachability_multiscene.py \
  --input-dir /home/kublab/ros2_ws/reachability_icra_confirmatory_v1 \
  --output-dir /home/kublab/ros2_ws/reachability_icra_confirmatory_v1/analysis \
