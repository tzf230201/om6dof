...
CONFIRMATORY_PROTOCOL_ID = "icra_confirmatory_v1"
CONFIRMATORY_STREAMS = tuple(range(100, 160))
CONFIRMATORY_SCENES = 60
CONFIRMATORY_BASE_TRAJECTORIES = 30
CONFIRMATORY_MODEL_HASHES = {
    "expanded_urdf_sha256": "485617d99a2483abd6327b03bb6d3a0a52f71be08adba6234343e1e4a1cd328a",
...
def validate_protocol(args, catalog, catalog_sha256, methods, stream_ids):
    ...
    if catalog["catalog_id"] != "om6dof_icra_scene_catalog_v1":
        errors.append("catalog_id must equal om6dof_icra_scene_catalog_v1")
...
def query_contract_errors(
    ...
    if phase == "clear" and (
        int(row.get("blocked_nodes", -1)) != 0
        or int(row.get("blocked_edges", -1)) != 0
    ):
        errors.append("clear_query_reported_blocked_graph_elements")
