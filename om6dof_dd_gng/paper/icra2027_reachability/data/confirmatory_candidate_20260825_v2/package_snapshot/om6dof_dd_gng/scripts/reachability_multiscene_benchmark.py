...
CONFIRMATORY_PROTOCOL_ID = "icra_confirmatory_v2"
...
def validate_protocol(args, catalog, catalog_sha256, methods, stream_ids):
    ...
    if catalog["catalog_id"] != "om6dof_icra_scene_catalog_v2":
        errors.append("catalog_id must equal om6dof_icra_scene_catalog_v2")
