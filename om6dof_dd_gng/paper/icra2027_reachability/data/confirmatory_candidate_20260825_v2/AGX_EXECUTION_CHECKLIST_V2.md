# AGX execution checklist — ICRA confirmatory reachability v2
...
Transfer `source_snapshot.tar.gz`, `CONFIRMATORY_PROTOCOL_V2.md`, and this checklist
to `/home/kublab/ros2_ws/confirmatory_candidate_20260825_v2/`. Expected hashes:

```text
source_snapshot.tar.gz
  337d74947e09e9a5e8e32b679c0536698ba27f6be844ab205546c7a6716769f7
CONFIRMATORY_PROTOCOL_V2.md
  13c44a3c80d0c5ad9faccade7f1952234f0bf551e2123c4599b47626ac8e681b
SOURCE_MANIFEST.json (inside the archive; this is source_tree_sha256)
  a5d5a68360b059e085d6932ab545ecf4a65eb990e2ccf7ec697534b19185e8d6
```

On AGX:

```bash
cd /home/kublab/ros2_ws/confirmatory_candidate_20260825_v2
sha256sum source_snapshot.tar.gz CONFIRMATORY_PROTOCOL_V2.md
mkdir -p extracted
...
tar -czf om6dof_dd_gng_before_confirmatory_v2_20260825.tar.gz \
  -C /home/kublab/ros2_ws/src/om6dof om6dof_dd_gng
rsync -a \
  /home/kublab/ros2_ws/confirmatory_candidate_20260825_v2/extracted/package_snapshot/om6dof_dd_gng/ \
...
colcon build --packages-up-to om6dof_dd_gng --symlink-install \
  ...
  --event-handlers console_direct+ 2>&1 | tee confirmatory_build_v2_20260825.log
source install/setup.bash
colcon test --packages-select om6dof_dd_gng \
  --event-handlers console_direct+ 2>&1 | tee confirmatory_test_v2_20260825.log
colcon test-result --verbose 2>&1 | tee confirmatory_test_result_v2_20260825.log
```
...
sha256sum \
  ...
  confirmatory_build_v2_20260825.log \
  confirmatory_test_v2_20260825.log \
  confirmatory_test_result_v2_20260825.log
```
...
python3 src/om6dof/om6dof_dd_gng/scripts/generate_reachability_scene_catalog.py \
  --output /home/kublab/ros2_ws/reachability_scene_catalog_icra_v2.json \
  --catalog-id om6dof_icra_scene_catalog_v2 \
  --scene-count 60 \
  ...
  2>&1 | tee /home/kublab/ros2_ws/reachability_scene_catalog_icra_v2_generation.log
```
...
fails, fix the pipeline and declare protocol v2 before collecting outcomes.
...
python3 src/om6dof/om6dof_dd_gng/scripts/reachability_multiscene_benchmark.py \
  --catalog /home/kublab/ros2_ws/reachability_scene_catalog_icra_v2.json \
  --protocol-id icra_confirmatory_v2 \
  ...
  --rmw-implementation rmw_fastrtps_cpp \
  --source-tree-sha256 a5d5a68360b059e085d6932ab545ecf4a65eb990e2ccf7ec697534b19185e8d6 \
  --expected-catalog-sha256 <CATALOG_SHA256> \
  --catalog-generation-log /home/kublab/ros2_ws/reachability_scene_catalog_icra_v2_generation.log \
  --source-snapshot /home/kublab/ros2_ws/confirmatory_candidate_20260825_v2/source_snapshot.tar.gz \
  --protocol-document /home/kublab/ros2_ws/confirmatory_candidate_20260825_v2/CONFIRMATORY_PROTOCOL_V2.md \
  --analyzer-script /home/kublab/ros2_ws/src/om6dof/om6dof_dd_gng/scripts/analyze_reachability_multiscene.py \
  --output-dir /home/kublab/ros2_ws/reachability_icra_confirmatory_v2 \
  --dry-run
```
...
```bash
python3 \
  /home/kublab/ros2_ws/reachability_icra_confirmatory_v2/frozen_inputs/analyze_reachability_multiscene.py \
  --input-dir /home/kublab/ros2_ws/reachability_icra_confirmatory_v2 \
  --output-dir /home/kublab/ros2_ws/reachability_icra_confirmatory_v2/analysis \
