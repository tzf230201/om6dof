...
summary={'run_directory':str(run),'binary':str(Path(args.binary).resolve()),'domain':219,'obstacle_clearance':p['obstacle_clearance'],'actions_or_hardware':False,'plans':[],'diagnostics':[],'pregrasp_refinement_enabled':p['pregrasp_refinement_enabled'],'snapshot':'Earlier complete collision capture, not the newer unavailable live environment','execution_validation_checks':[]}
