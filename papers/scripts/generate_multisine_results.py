...
def main():
    default_root = Path("/home/kublab/ros2_ws/src/om6dof")
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--csv", type=Path,
                        default=Path("/home/kublab/tf_identification/multisine_teaching_all.csv"))
    parser.add_argument("--xacro", type=Path,
                        default=default_root / "om6dof_description/urdf/om6dof.urdf.xacro")
    parser.add_argument("--fit-script", type=Path,
                        default=default_root / "om6dof_controllers/scripts/fit_gravity_friction.py")
    parser.add_argument("--output-dir", type=Path, default=default_root / "papers")
